package com.nikesh.project.shoppingcart.Adapter;
...
import static com.nikesh.project.shoppingcart.MainActivity.arrayList;
...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ProductAdapter.ViewHolder viewHolder, final int i) {
        ...
        viewHolder.productImage.setImageDrawable(ContextCompat.getDrawable(context, productsArray.get(i).getImagePath()));
        Log.d("Image NAme", String.valueOf(ContextCompat.getDrawable(context, productsArray.get(i).getImagePath())));
        viewHolder.productImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Set dialog title
                dialog.setTitle("Add " + productsArray.get(i).productName);
                ...
                updateQtyDialog.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(context, String.valueOf(productsArray.get(i).productName + " " + cartCounter[0]) + " Added", Toast.LENGTH_SHORT).show();
