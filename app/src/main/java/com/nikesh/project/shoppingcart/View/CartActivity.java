...
import com.nikesh.project.shoppingcart.Shippingactivity;

import java.util.ArrayList;

import static com.nikesh.project.shoppingcart.Adapter.ProductAdapter.cartModels;
...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Diva's Cart");
...
//                addItemInCart.clear();
        ...
        proceedToBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("Total", String.valueOf(grandTotalplus));
