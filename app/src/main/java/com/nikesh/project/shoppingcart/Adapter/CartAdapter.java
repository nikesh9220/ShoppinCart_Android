...
import static com.nikesh.project.shoppingcart.View.CartActivity.grandTotal;
import static com.nikesh.project.shoppingcart.View.CartActivity.grandTotalplus;
import static com.nikesh.project.shoppingcart.View.CartActivity.temparraylist;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final CartAdapter.ViewHolder holder, final int position) {
        ...
        requestOptions.placeholder(R.drawable.chillipowder);
        requestOptions.error(R.drawable.chillipowder);
        ...
        holder.cartIncrement.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("totalcashthegun", String.valueOf(grandTotalplus));
                grandTotal.setText("INR "+ String.valueOf(grandTotalplus));
